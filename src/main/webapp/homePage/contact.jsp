      ...
      <div class="container logo-wrap">
        <div class="row pt-5">
          <div class="col-12 text-center">
            ...
            <h1 class="site-logo"><a href="index.jsp">Balita</a></h1>
          </div>
        </div>
      </div>
          ...
          <div class="collapse navbar-collapse" id="navbarMenu">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="category.jsp" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Travel</a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="category.jsp" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Categories</a>
                <div class="dropdown-menu" aria-labelledby="dropdown05">
                  <a class="dropdown-item" href="category.jsp">Lifestyle</a>
                  <a class="dropdown-item" href="category.jsp">Food</a>
                  <a class="dropdown-item" href="category.jsp">Adventure</a>
                  <a class="dropdown-item" href="category.jsp">Travel</a>
                  <a class="dropdown-item" href="category.jsp">Business</a>
                </div>
