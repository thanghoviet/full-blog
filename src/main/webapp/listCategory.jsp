            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="header-wrap">
                        <form class="form-header" action="${pageContext.request.contextPath}/category?action=search" method="GET">
                            ...
                            <div class="table-data__tool">
                                ...
                                <div class="table-data__tool-right">
                                    ...
                                    <div class="table-data__tool-left">
                                        <a href="${pageContext.request.contextPath}/category?action=create" class="btn btn-primary btn-sm" style="color: black">
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <button class="item" data-toggle="tooltip" data-placement="top"
                                                                title="Delete">
                                                            <a href="/category?action=delete&id=${category.id}"> <i
                                                                    class="zmdi zmdi-delete"></i></a>
                                                            <a href="#" onclick="deleteNote(${category.id})"
        ...
        <script>
            function deleteNote(id) {
                ...
                if (showMessage) {
                    ...
                    window.location = "/category?action=delete&id=" + id;
                } else {
                }
            }
        </script>
