...
<%--                                vị trí nút--%>
                                <div class="table-data__tool-left">
                                    <a href="${pageContext.request.contextPath}/user?action=create" class="btn btn-primary btn-sm" style="color: black">
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <c:forEach var="user" items="${listUser}">
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td><c:if test="${user.role==true}">
                                                    <option value="${user.id}"
                                                            selected>admin
                                                    </option>
                                                </c:if>
                                                    <c:if test="${user.role == false}">
                                                        <option value="${user.id}" selected>member</option>
                                                    </c:if></td>
                                                <td><c:out value="${user.aboutMe}"/></td>
                                                <td><c:out value="${user.image}"/></td>
                                                <td><c:out value="${user.createDate}"/></td>
                                                <td><c:out value="${user.yearOfBirth}"/></td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <button class="item" data-toggle="tooltip" data-placement="top"
                                                                title="Delete">
                                                            <a href="${pageContext.request.contextPath}/user?action=delete&id=${user.id}"> <i
